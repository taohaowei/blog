...
CREATE TABLE blog_00.t_blog_00 (
...
CREATE TABLE blog_00.t_viewLog_00 (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '日志编号',
  `ipAddress` varchar(255) DEFAULT NULL COMMENT '请求者Ip',
  `ipMsg` varchar(255) DEFAULT NULL COMMENT 'ip地址对应的地区',
  `requestURL` text COMMENT '请求URL',
  `params` text COMMENT '请求参数',
  `sessionId` varchar(255) DEFAULT NULL COMMENT '请求者SessionId',
  `viewTime` datetime DEFAULT NULL COMMENT '请求发生的时间',
  `visiter` int(10) unsigned zerofill DEFAULT NULL COMMENT '本次访问博客操作次数',
  `spendTime` int(10) unsigned zerofill DEFAULT NULL COMMENT '本次请求所耗费时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13342 DEFAULT CHARSET=utf8;



CREATE TABLE blog_00.t_ban_00 (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ip` varchar(255) NOT NULL COMMENT '被Ban的用户Ip',
  `ban` int(1) NOT NULL DEFAULT '1' COMMENT '是否被ban了，1为被ban，0为解除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
